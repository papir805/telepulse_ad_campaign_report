...
The script can be found [here need-to-fill-in]()

Using data from September and October 2017, I've generated the three reports [here need-to-fill-in]() and created visuals in another jupyter notebook to help identify the most cost efficient networks. 
The jupyter notebook can be found [here need-to-fill-in]()
